...
def send_welcome(message):
    ...
    caption = (
        ...
        "Мы также недавно начали вести <a href=\"https://t.me/arlettelife\">наш телеграм-канал</a>, "
        "куда часто публикуем закадровую жизнь моделей, бэки со съёмок, советы для new face.\n"
